# Frontend - Udacity Full Stack Developer Nanodegree

This directory contains the Frontend for the Capstone project.

Built with `npm create vite@latest frontend -- --template react-ts`.
