...
def upgrade():
    ...
    sa.Column('genre', sa.Enum('ACTION_AND_ADVENTURE', 'ANIMATION', 'COMEDY', 'DOCUMENTARY', 'DRAMA', 'HISTORICAL', 'HORROR', 'NOIR', 'SCI_FI', 'WESTERN', name='genre'), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    sa.Enum('ACTION_AND_ADVENTURE', 'ANIMATION', 'COMEDY', 'DOCUMENTARY', 'DRAMA', 'HISTORICAL', 'HORROR', 'NOIR', 'SCI_FI', 'WESTERN', name='genre').drop(op.get_bind())
